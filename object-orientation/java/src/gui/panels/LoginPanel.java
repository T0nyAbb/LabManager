...
public class LoginPanel extends JPanel {
	...
	private void generateLabels() {
        ...
        usernameLabel.setBounds(132, 250, 177, 14);
        add(usernameLabel);
        
        passwordLabel = new JLabel("Password");
        passwordLabel.setFont(new Font("Arial", Font.PLAIN, 14));
        passwordLabel.setBounds(132, 310, 177, 14);
        add(passwordLabel);
	...
	private void generateSignupButton() {
        ...
        signupButton.setText("<HTML><U>Non hai un account? Registrati.</U></HTML>");
	...
	private void signup() {
		controller.getAccessFrame().showSignupPanel();
	}
