...
public class SignupPanel extends JPanel {
	...
	private void generateLabels() {
        ...
        signupSuccessfulLabel.setFont(new Font("Tahoma", Font.PLAIN, 11));
	...
	private void generateLoginButton() {
        ...
        loginButton.setText("<HTML><U>Sei gia' registrato? Accedi.</U></HTML>");
	...
	private void login() {
		controller.getAccessFrame().showLoginPanel();
	}
