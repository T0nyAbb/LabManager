...
public class SimilarPasswordException extends Exception{
	...
	public SimilarPasswordException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
	...
	public String getMessage() {
		return "La password inserita e' gia' stata utilizzata!";
	}
}
