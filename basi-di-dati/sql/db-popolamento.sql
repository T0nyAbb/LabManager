...
--SEZIONE SEDE
INSERT INTO SEDE (INDIRIZZO, ID_LABORATORIO) 
VALUES ('Via Duomo 23', (SELECT ID_LABORATORIO FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%NEWTON%') FETCH NEXT 1 ROWS ONLY));
INSERT INTO SEDE (INDIRIZZO, ID_LABORATORIO) 
VALUES ('Via Scarlatti 77', (SELECT ID_LABORATORIO FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%TESLA%') FETCH NEXT 1 ROWS ONLY));
INSERT INTO SEDE (INDIRIZZO, ID_LABORATORIO) 
VALUES ('Via dei mille 43', (SELECT ID_LABORATORIO FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%NEWTON%') FETCH NEXT 1 ROWS ONLY));
