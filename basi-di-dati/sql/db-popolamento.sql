...
INSERT INTO PRENOTAZIONE(DataInizio, Durata, Username, ID_STRUMENTO)
VALUES ((SELECT TO_DATE('2025/07/10 07:30', 'YYYY/MM/DD HH24:MI') FROM DUAL), 5, 'MadScientist', (SELECT ID_STRUMENTO FROM STRUMENTO WHERE UPPER(STRUMENTO.DESCRIZIONE) LIKE ('%MICROSCOPIO%') FETCH NEXT 1 ROWS ONLY));


--Login Test
SELECT autenticazione('CicciogameR89', 'paguro89') FROM DUAL;
