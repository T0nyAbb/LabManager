...
VALUES ('Via Duomo 23 80138 Napoli', (SELECT ID_LAB FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%NEWTON%') FETCH NEXT 1 ROWS ONLY));
INSERT INTO SEDE (INDIRIZZO, ID_LAB) 
VALUES ('Via Scarlatti 77 80131 Napoli', (SELECT ID_LAB FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%TESLA%') FETCH NEXT 1 ROWS ONLY));
INSERT INTO SEDE (INDIRIZZO, ID_LAB) 
VALUES ('Via dei mille 43 80132 Napoli', (SELECT ID_LAB FROM LABORATORIO WHERE UPPER(LABORATORIO.NOME) LIKE ('%NEWTON%') FETCH NEXT 1 ROWS ONLY));
