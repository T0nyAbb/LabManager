...
--SEZIONE UTENTE
INSERT INTO UTENTE VALUES ('cicciogamer89', (SELECT UTL_I18N.STRING_TO_RAW(LTRIM(RTRIM('paguro89')), 'AL32UTF8') FROM DUAL), 'cicciogamer89@paguro.it');
INSERT INTO UTENTE VALUES ('MadScientist', (SELECT UTL_I18N.STRING_TO_RAW(LTRIM(RTRIM('Einstein111')), 'AL32UTF8') FROM DUAL), 'albertEinstein22@mail.it');

--SEZIONE PRENOTAZIONE
INSERT INTO PRENOTAZIONE(DURATA,DATAINIZIO,ID_STRUMENTO,USERNAME) 
VALUES (2, (SELECT TO_DATE('2025/05/10 16:30', 'YYYY/MM/DD HH24:MI') FROM DUAL), (SELECT ID_STRUMENTO FROM STRUMENTO WHERE UPPER(STRUMENTO.DESCRIZIONE) LIKE ('%OSCILLOSCOPIO%') FETCH NEXT 1 ROWS ONLY), (SELECT USERNAME FROM UTENTE WHERE UPPER(UTENTE.USERNAME) LIKE('%CICCIO%') FETCH NEXT 1 ROWS ONLY)
);                      
